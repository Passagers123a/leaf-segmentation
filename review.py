...
files = {
    ...
    "jpg3": "testing_files/4ac89748-5322-447e-a97d-d1ef03c46893.jpg",
    "jpg4": "testing_files/d9f9c117-b4fc-4887-b514-8446fd9fb1b1.jpg",
    "jpg5": "testing_files/ccd145d1-90e6-4c45-a96d-885baeb9cda5.jpg",
    "jpg6": "testing_files/92215832-f71c-4e8e-8096-25bbcf0784d1.jpg",
    "jpg7": "testing_files/1b822304-219c-464a-89a7-58b7e77dd69d.jpg",
    "jpg8": "testing_files/05e66a71-d5ee-437f-a3ba-796334ce636d.jpg",
    "jpg9": "testing_files/p2_s.jpg",
    "jpg10": "testing_files/apple.jpg",
    "jpg11": "testing_files/pear.jpg"
}
...
def review_texture_filter(file_name):
    try:
        ...
        image = original_image.copy()
        image[np.logical_not(marker)] = np.array([0]).astype('int64')      
        image[marker] = np.array([255]).astype('int64')
    except ValueError as err:
        if str(err) == IMAGE_NOT_READ:
            print('Error: Couldnot read image file: ', file_name)
        elif str(err) == NOT_COLOR_IMAGE:
