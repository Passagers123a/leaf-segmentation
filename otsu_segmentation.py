...
def apply_marker(image, marker, background = 0, inverse = True):
    ...
    if (inverse) and (True in unique_counts) and (False in unique_counts ):#and( unique_counts[True] - unique_counts[False] < 2000000)
...
def segment_with_otsu(image, background = 0):
    """
...
if __name__ == '__main__':
    ...
    image="d9f9c117-b4fc-4887-b514-8446fd9fb1b1.jpg"
    ret_val, segmented_image=segment_with_otsu(image, background = 0)
